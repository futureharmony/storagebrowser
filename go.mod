module github.com/futureharmony/storagebrowser/v2
...
require (
	...
	github.com/futureharmony/afero-aws-s3 v0.0.0-20260205012024-5620d9e5ea04
...
require github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.22.6 // indirect

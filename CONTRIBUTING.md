...
```bash
git clone https://github.com/futureharmony/storagebrowser
```
...
1. Add it to [`auth` directory](https://github.com/futureharmony/storagebrowser/blob/master/auth).
2. Add it to the [configuration parser](https://github.com/futureharmony/storagebrowser/blob/master/cmd/config.go) for the CLI.
3. Add it to the [`authBackend.Get`](https://github.com/futureharmony/storagebrowser/blob/master/storage/bolt/auth.go).
